    ...
    <div class="max-w-4xl mx-auto py-10 space-y-10">
        <div class="flex items-center gap-6">
            ...
            <div>
                ...
                <p class="text-gray-400 font-medium">{{ __('admin.update_parameters_for') }} {{ $role->name }}.</p>
            </div>
        </div>
            ...
            <div class="space-y-8">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div class="space-y-2">
                        ...
                        <input type="text" name="name" value="{{ $role->name }}" required class="w-full px-6 py-4 rounded-2xl bg-gray-50 border-none focus:ring-2 focus:ring-red-500 font-bold text-gray-900">
                    </div>
                ...
                <div class="space-y-2">
                    ...
                    <textarea name="description" rows="3" class="w-full px-6 py-4 rounded-2xl bg-gray-50 border-none focus:ring-2 focus:ring-red-500 font-bold text-gray-900">{{ $role->description }}</textarea>
                </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        <label class="flex items-center gap-4 p-4 rounded-2xl bg-gray-50 hover:bg-gray-100 transition-colors cursor-pointer group">
                            <input type="checkbox" name="permissions[]" value="{{ $permission->id }}" {{ in_array($permission->id, $rolePermissions) ? 'checked' : '' }} class="w-5 h-5 rounded border-gray-300 text-red-600 focus:ring-red-500">
